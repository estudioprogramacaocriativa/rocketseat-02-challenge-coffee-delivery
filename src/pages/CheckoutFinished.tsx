...
export function CheckoutFinished() {
    return (
        <div className="mt-36 max-w-6xl mx-auto px-5 lg:px-0">
            <section>
                <header>
                    <h1 className="text-yellow-dark font-bold font-baloo text-xl md:text-3xl">Uhu! Pedido confirmado</h1>
                    <p className="text-base-subtitle text-xs md:text-lg">Agora e só aguardar que logo o café chega ate você.</p>
                </header>

                <div className="grid md:grid-cols-2 gap-6 md:gap-20 mt-6">
                    <div
                        className="h-full w-full rounded-md bg-gradient-to-r from-background via-base-text to-yellow rounded-tr-2xl rounded-bl-2xl border"
                    >
                        <div className="h-full w-full bg-white rounded-md p-10 space-y-5">
                            <div className="flex items-center gap-4">
                                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-purple">
                                    <img className="w-4 h-4 text-white" src={pin} alt=""/>
                                </div>
                            ...
                            <div className="w-8 h-8 flex items-center justify-center rounded-full bg-yellow">
                                    <img className="w-4 h-4 text-white" src={clock} alt=""/>
                                </div>
                                <div className="text-base-text text-base">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-yellow-dark">
                                    <img className="w-4 h-4 text-white" src={dollar} alt=""/>
                                </div>
                                <div className="text-base-text text-base">
